...
namespace OrienteeringApi.Migrations
{
    ...
    [Migration("20210217164400_SeedSchool")]
            ...
            modelBuilder.Entity("OrienteeringApi.Database.School", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2021, 2, 17, 16, 44, 0, 390, DateTimeKind.Local).AddTicks(2241),
                            Modified = new DateTime(2021, 2, 17, 16, 44, 0, 390, DateTimeKind.Local).AddTicks(2241),
                            Name = "St Trinians",
                            Postcode = "W99 9XX",
                            Type = "Primary"
                        });
