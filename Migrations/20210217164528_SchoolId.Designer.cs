...
namespace OrienteeringApi.Migrations
{
    ...
    [Migration("20210217164528_SchoolId")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrienteeringApi.Database.School", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Address = "1 Acatia Crescent",
                            Contact = "Miss Hilda Han-Hindenberg",
                            Created = new DateTime(2021, 2, 17, 16, 45, 27, 472, DateTimeKind.Local).AddTicks(1739),
                            Modified = new DateTime(2021, 2, 17, 16, 45, 27, 472, DateTimeKind.Local).AddTicks(1739),
                            Name = "St Trinians",
                            Postcode = "W99 9XX",
                            Type = "Primary"
                        });
            ...
            modelBuilder.Entity("OrienteeringApi.Database.LessonControl", b =>
                {
                    b.HasOne("OrienteeringApi.Database.Control", "Control")
                        .WithMany()
